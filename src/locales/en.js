...
module.exports = {
  meta: {
    ...
    pages: {
      home: {
        ...
        description:
          'Mustafa Kelesoglu builds fast, responsive websites and custom web applications for companies, associations and digital projects. WordPress, Node.js and security-focused development from Dinslaken, NRW, Germany and remote.',
      },
      projects: {
      ...
      cv: {
        title: 'CV',
        description:
          'Short profile, education, languages and focus areas of Mustafa Kelesoglu. CV as PDF on request or available for download once approved.',
      },
      contact: {
  ...
  home: {
    evidence: {
      label: 'Verifiable',
      items: [
        { label: 'Three live client websites', detail: 'WordPress, Elementor, WooCommerce' },
        { label: 'Two personal software projects', detail: 'Full-stack product and security R&D' },
        { label: 'Three working languages', detail: 'German · English · Turkish' },
        { label: 'Germany and remote', detail: 'Dinslaken, Duisburg, NRW, and anywhere online' },
      ],
    },
    featured: {
  ...
  about: {
    ...
    lead: 'I am Mustafa Kelesoglu, a web developer based in Dinslaken, North Rhine-Westphalia, Germany. I build websites and web applications that load fast, work on every device and are configured securely from the start.',
    story: [
  ...
  contact: {
    ...
    form: {
      ...
      attachmentsHint: 'Up to 5 files · PDF, DOC, DOCX or TXT · max. 10 MB total',
      attachmentsCountLabel: '{count} / {max} files',
      attachmentsTotalLabel: 'Total: {size} / {max}',
      attachmentsRemove: 'Remove {name}',
    ...
    errors: {
      ...
      attachmentsSize: 'The selected files are too large together (10 MB total maximum).',
      attachmentsType: 'Unsupported file type. Allowed formats are PDF, DOC, DOCX or TXT.',
      uploadFailed: 'The uploaded files could not be processed. Please try again or send the request without attachments.',
  ...
  legal: {
    imprint: {
      ...
      sections: [
        {
          title: 'Provider',
          lines: ['Mustafa Kelesoglu', 'Web development', '46537 Dinslaken', 'Germany'],
        },
        { title: 'Contact', lines: ['Email: {email}'] },
        { title: 'Responsible for content', lines: ['Mustafa Kelesoglu'] },
        {
    ...
    privacy: {
      ...
      sections: [
        {
          title: '1. Controller',
          paragraphs: ['The controller for data processing on this website is Mustafa Kelesoglu, Dinslaken, Germany. Contact: {email}.'],
        },
        {

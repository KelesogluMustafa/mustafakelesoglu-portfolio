...
const projects = [
  ...
  },
  {
    ...
    year: null,
    liveUrl: null,
    previewUrl: 'https://staging.lesedeutsch.de/',
    repoUrl: null,
    statusKey: 'inDevelopment',
    tech: ['JavaScript', 'PWA', 'Web Speech API', 'Vite', 'Wiktionary-Daten', 'Responsive Design'],
    media: { desktop: 'lesedeutsch-desktop.png', mobile: 'lesedeutsch-mobile.png' },
    accent: 'amber',
    i18n: {
      de: {
        title: 'LeseDeutsch',
        tagline: 'Deutsch lesen lernen: Geschichten nach Niveau, Wort antippen, zuhören.',
        summary:
          'LeseDeutsch ist eine Lern-App für Deutsch als Fremdsprache. Kurze Geschichten sind nach den Niveaus A1 bis C2 sortiert und werden Satz für Satz mit Übersetzung angezeigt; ein Tipp auf ein Wort zeigt Bedeutung und Wortformen, und jeder Satz kann vorgelesen werden. Dazu kommen ein Grundwortschatz nach Niveau und Übungen im Format von telc- und Goethe-Prüfungen. Das Projekt befindet sich in Entwicklung; eine öffentliche Testversion läuft unter staging.lesedeutsch.de.',
        problem:
          'Wer Deutsch lernt, braucht Lesetexte auf dem passenden Niveau – und beim Lesen ständig Hilfe: Was bedeutet dieses Wort, wie lautet der Plural, wie wird der Satz ausgesprochen? Meist heißt das, zwischen Text, Wörterbuch und Übersetzer hin- und herzuwechseln. Gebraucht wurde ein Ort, an dem Lesen, Wortschatz, Aussprache und Prüfungsvorbereitung zusammenkommen.',
        role: 'Konzept, Inhalte, Oberfläche und Umsetzung – als eigenes Produktprojekt selbst entwickelt.',
        solution:
          'Eine installierbare Web-App (PWA) mit drei Bereichen: Geschichten, Wörter und Prüfungen. Geschichten lassen sich nach Niveau filtern und Satz für Satz lesen, wahlweise mit eingeblendeter Übersetzung. Die Sprachausgabe nutzt die deutschen Stimmen des eigenen Geräts, mit Satznavigation und wählbarer Geschwindigkeit. Wortformen und Bedeutungen stammen teilweise aus freien Wörterbüchern (Wiktionary, WikDict); automatisch übernommene Bedeutungen sind als noch nicht geprüft gekennzeichnet.',
        features: [
          'Geschichten nach Niveau A1–C2 mit Übersetzung Satz für Satz (ein- und ausblendbar)',
          'Wort antippen: Bedeutung und Wortformen (Genus, Plural, Verbformen)',
          'Vorlesen Satz für Satz mit den Gerätestimmen, Geschwindigkeit 0,75×/1×/1,25×',
          'Grundwortschatz nach Niveau, filterbar nach Wortart, mit Merkliste',
          'Eigene Übungen im Format von telc- und Goethe-Prüfungen (z. B. Lesen, Sprachbausteine)',
          'Oberfläche auf Deutsch, Englisch und Türkisch; Bedeutungen auf Türkisch oder Englisch, weitere Sprachen geplant',
          'Leseeinstellungen: Schriftgröße, Lesebreite, Zeilenabstand, Designs (Papier, Hell, Nacht) und Fokusmodus',
          'Installation auf dem Smartphone als PWA',
        ],
        security: [
          'Auslieferung über HTTPS',
          'Lesen, Wörter und Prüfungsübungen im aktuellen Stand ohne Konto nutzbar',
          'Sprachausgabe über die Stimmen des eigenen Geräts statt über einen externen Sprachdienst',
          'Quellen und Lizenzen der Wörterbuchdaten (CC BY-SA 4.0) werden in der App ausgewiesen',
        ],
        outcomes: ['Öffentliche Testversion 0.1.0 unter staging.lesedeutsch.de', 'Inhalte (Geschichten, Wortschatz, Prüfungsübungen) werden laufend erweitert'],
        outcomesNote: 'Noch nicht offiziell veröffentlicht. Nutzerzahlen werden nicht angegeben.',
        ctaTitle: 'Lern- oder Content-App geplant?',
        ctaText:
          'Ich entwickle Web-Apps, die auf dem Smartphone gut funktionieren, installierbar sind und strukturierte Inhalte verständlich aufbereiten.',
      },
      en: {
        title: 'LeseDeutsch',
        tagline: 'Learn to read German: stories by level, tap a word, listen.',
        summary:
          'LeseDeutsch is a learning app for German as a foreign language. Short stories are sorted by level from A1 to C2 and shown sentence by sentence with a translation; tapping a word shows its meaning and forms, and every sentence can be read aloud. It also includes a core vocabulary by level and exercises in the format of the telc and Goethe exams. The project is in development; a public test version runs at staging.lesedeutsch.de.',
        problem:
          'German learners need reading material at the right level, and constant help while reading: what does this word mean, what is the plural, how is the sentence pronounced? Usually that means switching back and forth between the text, a dictionary and a translator. What was needed was one place where reading, vocabulary, pronunciation and exam preparation come together.',
        role: 'Concept, content, interface and implementation, developed by me as a personal product project.',
        solution:
          'An installable web app (PWA) with three areas: stories, words and exams. Stories can be filtered by level and read sentence by sentence, optionally with the translation shown. Read-aloud uses the German voices available on the device, with sentence navigation and adjustable speed. Word forms and meanings come partly from free dictionaries (Wiktionary, WikDict); automatically imported meanings are marked as not yet reviewed.',
        features: [
          'Stories by level A1–C2 with sentence-by-sentence translation (can be shown or hidden)',
          'Tap a word: meaning and word forms (gender, plural, verb forms)',
          'Sentence-by-sentence read-aloud with device voices, speed 0.75×/1×/1.25×',
          'Core vocabulary by level, filterable by part of speech, with a saved-words list',
          'Original exercises in the format of the telc and Goethe exams (e.g. reading, language elements)',
          'Interface in German, English and Turkish; meanings in Turkish or English, more languages planned',
          'Reading settings: font size, reading width, line spacing, themes (paper, light, night) and focus mode',
          'Installable on the phone as a PWA',
        ],
        security: [
          'Served over HTTPS',
          'Reading, words and exam exercises currently usable without an account',
          'Read-aloud uses the device’s own voices instead of an external speech service',
          'Sources and licences of the dictionary data (CC BY-SA 4.0) are credited in the app',
        ],
        outcomes: ['Public test version 0.1.0 at staging.lesedeutsch.de', 'Content (stories, vocabulary, exam exercises) is being expanded continuously'],
        outcomesNote: 'Not officially released yet. User numbers are not stated.',
        ctaTitle: 'Planning a learning or content app?',
        ctaText:
          'I build web apps that work well on the phone, can be installed and present structured content clearly.',
      },
      tr: {
        title: 'LeseDeutsch',
        tagline: 'Almanca okumayı öğrenin: seviyeye göre hikâyeler, kelimeye dokun, dinle.',
        summary:
          'LeseDeutsch, yabancı dil olarak Almanca öğrenenler için bir uygulamadır. Kısa hikâyeler A1’den C2’ye seviyelere göre sıralanır ve cümle cümle çevirisiyle gösterilir; bir kelimeye dokunmak anlamını ve çekimlerini gösterir, her cümle sesli okunabilir. Ayrıca seviyeye göre temel kelime hazinesi ve telc ile Goethe sınav formatında alıştırmalar içerir. Proje geliştirme aşamasındadır; herkese açık test sürümü staging.lesedeutsch.de adresinde çalışıyor.',
        problem:
          'Almanca öğrenenlerin kendi seviyelerine uygun okuma metinlerine ve okurken sürekli yardıma ihtiyacı var: Bu kelime ne demek, çoğulu nasıl, cümle nasıl telaffuz ediliyor? Bu da genellikle metin, sözlük ve çeviri aracı arasında gidip gelmek demek. Okuma, kelime, telaffuz ve sınav hazırlığının bir arada olduğu tek bir yer gerekiyordu.',
        role: 'Konsept, içerik, arayüz ve uygulama; kişisel ürün projesi olarak kendim geliştirdim.',
        solution:
          'Hikâyeler, Kelimeler ve Sınavlar olmak üzere üç bölümden oluşan, kurulabilir bir web uygulaması (PWA). Hikâyeler seviyeye göre filtrelenip cümle cümle okunabilir, istenirse çeviri de gösterilir. Sesli okuma, cihazdaki Almanca sesleri kullanır; cümleler arasında gezinme ve hız ayarı vardır. Kelime çekimleri ve anlamları kısmen özgür sözlüklerden (Wiktionary, WikDict) gelir; otomatik aktarılan anlamlar henüz kontrol edilmemiş olarak işaretlenir.',
        features: [
          'A1–C2 seviyelerine göre hikâyeler, cümle cümle çeviri (gösterilip gizlenebilir)',
          'Kelimeye dokun: anlam ve çekimler (artikel, çoğul, fiil çekimleri)',
          'Cihaz sesleriyle cümle cümle sesli okuma, hız 0,75×/1×/1,25×',
          'Seviyeye göre temel kelime hazinesi, kelime türüne göre filtre ve kaydedilen kelimeler listesi',
          'telc ve Goethe sınav formatında özgün alıştırmalar (ör. okuma, dil yapıları)',
          'Almanca, İngilizce ve Türkçe arayüz; anlamlar Türkçe veya İngilizce, başka diller planlanıyor',
          'Okuma ayarları: yazı boyutu, okuma genişliği, satır aralığı, temalar (kâğıt, açık, gece) ve odak modu',
          'Telefona PWA olarak kurulabilme',
        ],
        security: [
          'HTTPS üzerinden sunum',
          'Okuma, kelimeler ve sınav alıştırmaları şu an hesap olmadan kullanılabiliyor',
          'Sesli okuma harici bir ses servisi yerine cihazın kendi seslerini kullanıyor',
          'Sözlük verilerinin kaynakları ve lisansları (CC BY-SA 4.0) uygulamada belirtiliyor',
        ],
        outcomes: ['staging.lesedeutsch.de adresinde herkese açık test sürümü 0.1.0', 'İçerikler (hikâyeler, kelime hazinesi, sınav alıştırmaları) sürekli genişletiliyor'],
        outcomesNote: 'Henüz resmî olarak yayınlanmadı. Kullanıcı sayısı verilmemiştir.',
        ctaTitle: 'Bir öğrenme veya içerik uygulaması mı planlıyorsunuz?',
        ctaText:
          'Telefonda iyi çalışan, kurulabilen ve yapılandırılmış içeriği anlaşılır biçimde sunan web uygulamaları geliştiriyorum.',
      },
    },
  },
  {

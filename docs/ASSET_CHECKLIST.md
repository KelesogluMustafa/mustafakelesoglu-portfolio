...
| LeseDeutsch   | `public/img/projects/lesedeutsch-desktop.png`   | `public/img/projects/lesedeutsch-mobile.png`   | 1600 × 1000 px (16:10) / 780 × 1560 px (9:18) | Screenshot of the test version at staging.lesedeutsch.de (e.g. a story with translations shown). |
